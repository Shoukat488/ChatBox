...
<article class="card-body mx-auto" style="max-width: 400px;">
	...
	<div class="form-group input-group">
        ...
        <input name="fullname" class="form-control" placeholder="Full name" required type="text">
    </div> <!-- form-group// -->
    <div class="form-group input-group">
    	<div class="input-group-prepend">
    ...
    <div class="form-group input-group">
        ...
        <input class="form-control" name="createPass" placeholder="Create password" required type="password">
    </div> <!-- form-group// -->
    <div class="form-group input-group">
    	<div class="input-group-prepend">
		    <span class="input-group-text"> <i class="fa fa-lock"></i> </span>
		</div>
        <input class="form-control" name="confirmPass" placeholder="Repeat password" required type="password">
    </div> <!-- form-group// -->                                      
